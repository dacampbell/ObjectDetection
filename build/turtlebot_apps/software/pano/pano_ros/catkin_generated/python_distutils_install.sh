...
cd "/home/duncan/Projects/honors_ws/src/turtlebot_apps/software/pano/pano_ros"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/duncan/Projects/honors_ws/src/turtlebot_apps/software/pano/pano_ros/setup.py" \
    build --build-base "/home/duncan/Projects/honors_ws/build/turtlebot_apps/software/pano/pano_ros" \
    install \
    $DESTDIR_ARG \
