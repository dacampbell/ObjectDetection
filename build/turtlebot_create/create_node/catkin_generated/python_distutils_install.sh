...
cd "/home/duncan/Projects/honors_ws/src/turtlebot_create/create_node"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/duncan/Projects/honors_ws/src/turtlebot_create/create_node/setup.py" \
    build --build-base "/home/duncan/Projects/honors_ws/build/turtlebot_create/create_node" \
    install \
    $DESTDIR_ARG \
