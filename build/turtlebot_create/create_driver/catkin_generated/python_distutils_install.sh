...
cd "/home/duncan/Projects/honors_ws/src/turtlebot_create/create_driver"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/duncan/Projects/honors_ws/src/turtlebot_create/create_driver/setup.py" \
    build --build-base "/home/duncan/Projects/honors_ws/build/turtlebot_create/create_driver" \
    install \
    $DESTDIR_ARG \
