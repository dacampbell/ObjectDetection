...
if("TRUE" STREQUAL "TRUE")
  set(create_gazebo_plugins_SOURCE_PREFIX /home/duncan/Projects/honors_ws/src/turtlebot_create_desktop/create_gazebo_plugins)
  set(create_gazebo_plugins_DEVEL_PREFIX /home/duncan/Projects/honors_ws/devel)
  ...
  set(create_gazebo_plugins_INSTALL_PREFIX /home/duncan/Projects/honors_ws/install)
...
if(NOT "/home/duncan/Projects/honors_ws/src/turtlebot_create_desktop/create_gazebo_plugins/include " STREQUAL " ")
  set(create_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/duncan/Projects/honors_ws/src/turtlebot_create_desktop/create_gazebo_plugins/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'create_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/duncan/Projects/honors_ws/src/turtlebot_create_desktop/create_gazebo_plugins/${idir}'.  Ask the maintainer 'Nate Koenig <nate@osrfoundation.org>' to fix it.")
    endif()
